...
class Carga_horaria_compartido extends Model
{
      //se especifica el nombre de la tabla
    protected $table='carga_horaria_compartido';
    ...
    public function profesor(){
        return $this->belongsTo(Profesor_compartido::class,'id_profesor');
    }
    ...
    public function profesoresCH(){ 
       ...
       //obtiene todas las asignaciones de horas pertenecientes a la carga horaria
    public function asignacionAsignaturasCompartido(){
        return $this->hasMany(Asignacion_horas_profesor::class,'id_carga_horaria_compartido');
    }
    //obtiene todas las actividades extra pertenecientes a la carga horaria
    public function actividadesExtraCompartido(){
        return $this->hasMany(Actividad_extra_ch::class,'id_carga_horaria_compartido');
    }
}
