<h3 class="TituloCarrerasPagina">{{$agricultura->nombreProgramaEducativo}}</h3>
<div class="card-body">
                <h2>Profesores de tiempo completo</h2>
                <table class="table table-bordered" id="tableCarAgriPTC">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id="tableCarAgriPA">
                    <thead class="thead-tabla">
                        <tr>
                            <th scope="col">Clave</th>
                            <th scope="col">Nombre</th>
                    ...
                    <tbody>@forelse($$cargasHorariasCompartidas as $ch)
                        @if(1 == 1 AND $ch->profesoresCH->tipoProfesor=='PA')
                        <tr>
                            <td>{{ $ch->id }}</td>
                            <td>{{ $ch->profesoresCH->nombre }} {{ $ch->profesoresCH->apellidoPaterno }} {{ $ch->profesoresCH->apellidoMaterno }}</td>
                            <td>{{ $ch->profesoresCH->tipoProfesor }}</td>
