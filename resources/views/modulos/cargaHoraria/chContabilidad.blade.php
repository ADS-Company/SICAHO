<h3 class="TituloCarrerasPagina">{{$conta->nombreProgramaEducativo}}</h3>
<div class="card-body">
                <h2>Profesores de tiempo completo</h2>
                <table class="table table-bordered" id="tableCarConPTC">
                    ...
                    <tbody>
                      @forelse($cargaHorariaConta as $ch)
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id="tableCarConPA">
                    <thead class="thead-tabla">
                        <tr>
                            <th scope="col">Clave</th>
                            <th scope="col">Nombre</th>
                    ...
                    <tbody>
                        ...
                        @if($ch->id_programa_educativo == 4 AND $ch->profesoresCH->tipoProfesor=='PA')
                        <tr>
                            <td>{{ $ch->id }}</td>
                            <td>{{ $ch->profesoresCH->nombre }} {{ $ch->profesoresCH->apellidoPaterno }} {{ $ch->profesoresCH->apellidoMaterno }}</td>
                            <td>{{ $ch->profesoresCH->tipoProfesor }}</td>
