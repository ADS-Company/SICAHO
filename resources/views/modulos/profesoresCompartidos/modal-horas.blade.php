        ...
        <div class="modal-dialog modal-lg" role="document">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('agregarHorasCompartido')}}">
                       {{ csrf_field() }}
                      <input class="form-control" type="hidden" id="idProfesor" name="idProfesor" placeholder="Escriba la clave" value="{{$profesor->id}}" >
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                <fieldset disabled>
                                     <input class="form-control" type="text" id="programaEduativo" name="programaEducativo" placeholder="Escriba la clave" value="{{$profesor->programaEducativo->nombreProgramaEducativo}}" >
                                     </fieldset>
                                  </div>
                              </div>
                            <div class="row">
    ...
    <div class="modal fade" id="ModalEliminarCargaHoraria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('eliminarCargaHorariaCompartido')}}">
                       {{ csrf_field() }}
                       <!--id de profesor-->
