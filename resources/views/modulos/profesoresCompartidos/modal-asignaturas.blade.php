 <!--VENTANA MODAL PARA AGREGAR ASIGNATURAS A PROFESOR-->
        ...
        <div class="modal-dialog modal-lg" role="document">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('agregarAsignacionAsignaturaCompartido')}}">
                       {{ csrf_field() }}
   ...
   <div class="modal fade" id="ModalActualizarAsignaturaProfesorCompartido" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="ModalEliminarAsignaturaProfesor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('eliminarAsignacionAsignaturaCompartido')}}">
                       {{ csrf_field() }}
                       <!--id de profesor-->
                      <input class="form-control" type="hidden" id="idProfesor" name="idProfesor" placeholder="Escriba la clave" value="{{$profesor->id}}" >
                       <!--id de asignatura-->
 ...
 <!--/VENTANA MODAL PARA ELIMINAR ASIGNATURA-->
   <!--VENTANA MODAL PARA ELIMINAR ASIGNATURA PROFESOR COMPARTIDO-->
    <div class="modal fade" id="ModalEliminarAsignaturaProfesorCompartido" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                   <h4 class="modal-title" id="exampleModalLabel">Eliminar asignatura ha profesor</h4>
