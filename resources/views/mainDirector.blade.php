        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item @yield('botonNavCargaHoraria','')">
                    <a class="nav-link" href="{{ url('/cargaHorariaD') }}">Carga horaria</a>
                </li>
                <li class="nav-item @yield('botonNavProfesores','')">
                    <a class="nav-link" href="{{ url('/profesoresD') }}">Profesores</a>
                </li>
                <li class="nav-item @yield('botonNavCarrreras','')">
                    <a class="nav-link" href="{{ url('/carrerasD') }}">Especialidades</a>
                </li>
                <li class="nav-item @yield('botonNavAsignaturas','')">
                    <a class="nav-link" href="{{ url('/asignaturasD') }}">Asignaturas</a>
                </li>
                <li class="nav-item @yield('botonNavCatalogos','')">
                    <a class="nav-link" href="{{ url('/catalogosD') }}">Profesores compartidos</a>
                </li>
                <li class="nav-item @yield('botonNavUsuarios','')">
                    <a class="nav-link" href="{{ url('/usuariosD') }}"></a>
                </li>
